...
C {devices/gnd.sym} -160 0 0 1 {name=l3 lab=GND}
C {devices/vsource.sym} -160 -50 2 0 {name=VDIFF value=0 savecurrent=false}
C {devices/gnd.sym} -160 -80 2 0 {name=l4 lab=GND}
...
.control
  ...
  plot deriv(v(VOUT)) title 'Voltage Gain (Av)'
.endc"}
